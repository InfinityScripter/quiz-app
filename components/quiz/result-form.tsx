    ...
    return (
        <div className="flex flex-col items-center justify-center  bg-gray-50 p-4">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                ...
                <p className="text-lg">Вы ответили правильно на <span
                className="font-bold text-purple-600"
                >{correctAnswers}</span> из <span
                className="font-bold text-purple-600"
                >{totalQuestions}</span> вопросов.</p>
                <p className="text-lg mb-4">Процент правильных ответов:
                   <span
                   className="font-bold text-purple-600"
